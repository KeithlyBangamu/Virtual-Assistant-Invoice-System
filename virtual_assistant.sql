...
--
-- Host: localhost    Database: virtual_assistant
-- ------------------------------------------------------
...
CREATE TABLE `invoice_services` (
  ...
  KEY `invoice_id_idx` (`invoice_id`) /*!80000 INVISIBLE */,
  KEY `service_id` (`service_id`) /*!80000 INVISIBLE */,
...
CREATE TABLE `invoices` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`),
  CONSTRAINT `client_id` FOREIGN KEY (`id`) REFERENCES `clients` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-28 22:16:19
